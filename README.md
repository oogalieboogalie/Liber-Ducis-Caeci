...
**A curated library of n8n workflow templates — AI agents, automation suites, and more.**
...
3. Select any `.json` file from a collection
4. Configure credentials (each collection has its own setup docs)
5. Activate
